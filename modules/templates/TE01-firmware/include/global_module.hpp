/**
 * @file global_module.hpp
 * @author Andreas Forstner, Finn Artmann
 * @brief Global module code which is used by all modules
 * @version 0.1
 * @date 2023-01-16
 *
 */
...
enum FRAME_STRUCTURE {
    /*Command element of the frame structure */
    CMD,
    /* Length element of the frame structure. */
    LEN,
    /* Data element of the frame structure. */
    DATA,
    /* CRC element of the frame structure. */
    CRC
};
