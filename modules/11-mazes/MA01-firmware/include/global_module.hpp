...
/**
 * @brief Flag to indicate that the SS is active
 *
 */
...
/**
 * @brief Called when Master selects this module.
 *        ISR Function which is called when Slave Select gets pulled from high to low
 *
 */
void ss_select();
