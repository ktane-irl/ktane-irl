...
router.get('/SimonSays/:version/:slot', (req, res) => {
...
router.put('/SimonSays/:version/:slot', (req, res) => {

    if (process.env.apiDummyMode === "true") {

        //For dummy-mode      
        const uri = req.path.split('/');
        simon_says.led = req.body.led;
        simon_says.statusLed = req.body.statusLed;
